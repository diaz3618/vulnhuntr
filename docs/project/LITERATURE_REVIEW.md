...
This document reviews academic and industry research related to using Large Language Models for security vulnerability detection, focusing on trustworthiness, reliability, and practical applicability to Vulnhuntr.
...
Shows LLMs can understand code semantics beyond pattern matching
...
Demonstrates bidirectional understanding of code structure
...
Shows LLMs can reason about complex code logic
...
LLMs can generate vulnerable code, but can they also detect it?
...
May affect Vulnhuntr's ability to verify security properties
...
Vulnhuntr aims to go beyond pattern matching
...
Can detect complex patterns but requires rule engineering
...
More rigorous but less accessible than LLM approaches
...
Pre-LLM ML approach; shows promise but limited by supervised learning
...
Traditional ML struggles with generalization—can LLMs do better?
...
Requires labeled training data for each vulnerability type
...
Directly comparable to Vulnhuntr's approach
...
Provides framework for evaluating Vulnhuntr systematically
...
Vulnhuntr uses this technique for analysis
...
Could improve Vulnhuntr's analysis depth
...
Vulnhuntr's non-determinism is a known challenge
...
Vulnhuntr's confidence scores need calibration
...
False positives in Vulnhuntr may be hallucinations
...
Add verification layer to Vulnhuntr
...
Can malicious code evade Vulnhuntr's detection?
...
Evaluate Vulnhuntr against obfuscated code
...
Vulnhuntr's scratchpad makes reasoning visible
...
Does Vulnhuntr truly understand vulnerabilities or pattern match?
...
Provides PoC and reasoning, better than black-box tools
...
Standard metrics for Vulnhuntr evaluation
...
Vulnhuntr's practical utility beyond detection accuracy
...
Vulnhuntr's API costs must be justified by findings
...
Vulnhuntr in automated workflows
...
The literature indicates that LLMs show real capability for code understanding but face persistent challenges with hallucinations, false positives, cost, and reproducibility. Rigorous evaluation of LLM-based security tools remains a gap in the research. Vulnhuntr provides a concrete system to study these questions empirically.

This project addresses the gap through systematic evaluation, comparison with established tools, and a focus on trustworthiness and practical enhancements.
...
1. Protect AI (2024). "Vulnhuntr: Zero Shot Vulnerability Discovery Using LLMs." <https://github.com/protectai/vulnhuntr>

2. OWASP (2021). "OWASP Benchmark." <https://owasp.org/www-project-benchmark/>

3. NIST (2023). "Juliet Test Suite for C/C++." <https://samate.nist.gov/SARD/>

### Additional Reading

1. Chakraborty, S., et al. (2021). "Deep Learning Based Vulnerability Detection: Are We There Yet?" TSE 2021.

2. Johnson, B., et al. (2013). "Why Don't Software Developers Use Static Analysis Tools to Find Bugs?" ICSE 2013.

---

**Note**: This literature review is updated as the project progresses and new relevant research is published.
