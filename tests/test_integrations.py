...
class TestGitHubIssueCreator:
    ...
    @patch("vulnhuntr.integrations.github_issues.REQUESTS_AVAILABLE", True)
    @patch("vulnhuntr.integrations.github_issues.requests")
    def test_create_issue_duplicate_skip(self, mock_requests, github_config, sample_finding):
        from vulnhuntr.integrations.github_issues import GitHubIssueCreator
...
class TestWebhookNotifier:
    ...
    @patch("vulnhuntr.integrations.webhook.REQUESTS_AVAILABLE", True)
    @patch("vulnhuntr.integrations.webhook.requests")
    def test_format_json_payload(self, mock_requests, webhook_config, sample_findings):
        from vulnhuntr.integrations.webhook import WebhookNotifier
    ...
    @patch("vulnhuntr.integrations.webhook.REQUESTS_AVAILABLE", True)
    @patch("vulnhuntr.integrations.webhook.requests")
    def test_format_slack_payload(self, mock_requests, webhook_config, sample_findings):
        from vulnhuntr.integrations.webhook import WebhookNotifier
    ...
    @patch("vulnhuntr.integrations.webhook.REQUESTS_AVAILABLE", True)
    @patch("vulnhuntr.integrations.webhook.requests")
    def test_format_discord_payload(self, mock_requests, webhook_config, sample_findings):
        from vulnhuntr.integrations.webhook import WebhookNotifier
    ...
    @patch("vulnhuntr.integrations.webhook.REQUESTS_AVAILABLE", True)
    @patch("vulnhuntr.integrations.webhook.requests")
    def test_format_teams_payload(self, mock_requests, webhook_config, sample_findings):
        from vulnhuntr.integrations.webhook import WebhookNotifier
    ...
    @patch("vulnhuntr.integrations.webhook.REQUESTS_AVAILABLE", True)
    @patch("vulnhuntr.integrations.webhook.requests")
    def test_send_batch_success(self, mock_requests, webhook_config, sample_findings):
        from vulnhuntr.integrations.webhook import WebhookNotifier
    ...
    def test_retry_on_server_error(self, mock_sleep, mock_requests, webhook_config, sample_findings):
        from vulnhuntr.integrations.webhook import WebhookNotifier
    ...
    @patch("vulnhuntr.integrations.webhook.REQUESTS_AVAILABLE", True)
    @patch("vulnhuntr.integrations.webhook.requests")
    def test_no_retry_on_client_error(self, mock_requests, webhook_config, sample_findings):
        from vulnhuntr.integrations.webhook import WebhookNotifier
